  ...
  return (
    <div className='w-full bg-white px-16'>
        <div className='w-full flex justify-between py-4 h-24'>
            ...
            <button className='flex p-2 justify-center items-center text-white font-bold bg-merah-bs rounded-md'><TbLocation size={20} className='mx-2'/>Lihat Alamat di GMaps</button>
        </div>
    </div>
  )
}
