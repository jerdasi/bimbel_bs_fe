        ...
        <div className=' w-full h-24 flex justify-between items-center bg-antique mx-auto px-4 lg:px-20 '>
            ...
            <div className={!nav ? 'fixed left-0 top-0 w-[50%] h-full border-r border-r-gray-400 bg-antique ease-in-out duration-500 md:hidden' : 'fixed left-[-100%]'} >
                ...
                <ul className='uppercase p-4'>
                    <li className='p-4 border-b border-gray-300 hover:text-merah-bs hover:font-bold'>Beranda</li>
                    <li className='p-4 border-b border-gray-300 hover:text-merah-bs hover:font-bold'>Testimoni</li>
                    <li className='p-4 border-b border-gray-300 hover:text-merah-bs hover:font-bold'>Paket Bimbingan</li>
                    <li className='p-4 border-b border-gray-300 hover:text-merah-bs hover:font-bold'>Faq</li>
                    <li className='p-4 border-b border-gray-300 hover:text-merah-bs hover:font-bold'>Daftar</li>
